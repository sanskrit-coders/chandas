...
setup(
  ...
  description='Metrical analysis tools for indic languages in general, and sanskrit in particular',
  long_description=long_description,

  # The project's main homepage.
  url='https://github.com/sanskrit-coders/chandas',
  ...
  install_requires=['regex', 'backports.functools_lru_cache', 'splinter'],
